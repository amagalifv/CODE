...
const char *AR_ARTICULOS_NO_VENDIDOS="articulosnovend.dat";
...
int contarArti();
bool cargarVentasMarzoEnArray(int vArt[], int pos);
void listarCantVenMarzoPorCodigo();
void mesDeMenorCantVentida2020 (int &menor, int &mes);
void cargarVentas1erTrimestreArray(int vArt[], int pos);
bool generarArchivNoVendidosMeses456_2022();
