...
void compararAhorroCategoriaPeriodos(){
    ...
    if(codCateg==7){
        ...
        cout<<"Ingrese el c�digo del servicio: ";
        cout<<"C�digo elegido: ";
        cin>>codNombreServ;
        while(codNombreServ<=0 && codNombreServ>contarRegistrosNombreServicios()){
            cout<<"Opcion ingresada inv�lida, escr�bala nuevamente: ";
            cin>>codNombreServ;
        }
    }
    ...
    cout<<"Ingrese el periodo a comparar (se comparar� el periodo actual con otro mes/a�o a elecci�n): "<<endl;
    cout<<"Mes: ";
    cin>>mes;
    cout<<"A�o: ";
    cin>>anio;
    ...
    if(porcentaje==0){
        ...
        if(porcentaje>=1 && porcentaje<=100){
            ...
            if(porcentaje>100){
                cout<<"Comparando ambos periodos gastaste un "<<porcentaje-100<<"% m�s que el periodo anterior."<<endl;
            }
        }
    }
}
...
void totalAhorroAnual(){
    ...
    mensajesListados("TOTAL DE AHORROS POR A�O");
    cout<<"\nIndique el a�o a informar: ";
    cin>>anio;
    ...
    cout<<"El total de dinero ahorrado durante el a�o "<<anio<<" fue de $"<<acumulador<<endl;
}
//FIN FUNCIONES
