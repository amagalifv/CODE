...
int WINAPI WinMain (HINSTANCE hThisInstance, HINSTANCE hPrevInstance,LPSTR lpszArgument,int nCmdShow){
    ...
    estilo1.style = CS_DBLCLKS; //distingue entre click y doble click

    estilo1.cbSize = sizeof (WNDCLASSEX); //tamaño de los estilos

    estilo1.hIcon = LoadIcon (NULL, IDI_QUESTION);//para settear icono de miniatura

    estilo1.hIconSm = LoadIcon (NULL, IDI_INFORMATION);//para settear icono de ventana

    estilo1.hCursor = LoadCursor (NULL, IDC_ARROW);//cambia la imagen del cursor edelmouse

    estilo1.lpszMenuName = NULL;   /* Sin Menu, crear una barra de menú */
